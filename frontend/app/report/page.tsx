...
function ReportContent() {
    ...
    const speakableText = `${report.diagnosis}. ${report.explanation}. Strength of confidence: ${report.confidence_score} percent.`;
...
export default function ReportPage() {
    return (
        <Suspense fallback={<div className="min-h-screen pt-24 text-center text-gold">Consulting the archives...</div>}>
            <ReportContent />
        </Suspense>
    );
}
